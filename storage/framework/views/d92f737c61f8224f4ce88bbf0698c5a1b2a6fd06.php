				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control"  rows="15" name="content"><?php echo e(old('content')); ?></textarea>
				...
				<div class="panel panel-primary">
					...
					<div id="collapse2" class="panel-collapse collapse">
						<div class="panel-body">
							<div class="form-group">
								<label>Adresse</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="autocomplete" placeholder="Enter your address" onFocus="geolocate()"  type="text">
							</div>

							<div class="form-group">
								<label>Numero</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="street_number" disabled="true">
							</div>

							<div class="form-group">
								<label>Route</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="route" disabled="true">
							</div>

							<div class="form-group">
								<label>Code postal</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="postal_code"
								disabled="true"  type="text">
							</div>

							<div class="form-group">
								<label>Ville</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="locality"
								disabled="true" type="text">
							</div>

							<div class="form-group">
								<label>Pays</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="country" disabled="true">
							</div>

							<div class="form-group">
								<label>Departement</label>
								<input class="form-control" name="titre" value="<?php echo e(old('titre')); ?>" id="administrative_area_level_1" disabled="true">
							</div>
